...
<link rel="icon" type="image/x-icon"
	href="${pageContext.request.contextPath}/resources/img/favicon-14x160.jpg" />

<!-- Font Awesome icons (free version)-->
<script src="https://use.fontawesome.com/releases/v5.19.3/js/all.js"
	crossorigin="anonymous"></script>
...
<body>
	...
	<nav id="total-nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top"
			...
			<div class="collapse navbar-collapse fl-sta "
				id="navbarSupportedContent" style="width-max: content-max">
				<ul class="navbar-nav mr-auto ">
					<li class="nav-item active" id="id1"><a class="nav-link"
						href="#">커뮤니티 </a></li>

					<li class="nav-item active" id="id2"><a class="nav-link"
						href="#">스토어</a></li>

				</ul>
			</div>

			<div class="collapse navbar-collapse fl-end">
			...
			<div class="collapse navbar-collapse " id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto ">
					...
					<li class="nav-item active"><a class="nav-link"
						href="${pageContext.request.contextPath}/qna/qna">고객센터</a></li>
		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top "
			...
			<div class="collapse navbar-collapse container"
				...
				<ul class="navbar-nav mr-auto collapse navbar-collapse">
					...
					<li class="nav-item active"><a class="nav-link"
						href="${pageContext.request.contextPath}/myhome/homeList">내집뽐내기</a>
					</li>
					<li class="nav-item active"><a class="nav-link"
						href="${pageContext.request.contextPath}/quiz/quizList">질문과답변</a>
					</li>
					<li class="nav-item active"><a class="nav-link" href="#">이벤트</a>
					</li>
				</ul>
			</div>
		</nav>
		<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top "
			...
			<div class="collapse navbar-collapse container "
				...
				<ul class="navbar-nav mr-auto collapse navbar-collapse ">
					...
					<li class="nav-item active "><a class="nav-link"
						href="${pageContext.request.contextPath}">Home </a></li>
					<li class="nav-item active"><a class="nav-link" href="#">베스트</a>
					</li>
					<li class="nav-item active"><a class="nav-link" href="#"
						id="grab">전문가의손길</a></li>
					<li class="nav-item active"><a class="nav-link" href="#"
						id="header-category">카테고리</a></li>

				</ul>
			</div>
		</nav>
		<nav
			class="navbar navbar-expand-lg navbar-light bg-light fixed-top cen-contain "
			id="header-cate"
			style="background-color: rgb(255, 255, 255); font-family: 'Cafe24SsurroundAir';">
			...
			<div
				class="collapse navbar-collapse container header-categorys nav-item2 fl-end"
				id="navbarNavAltMarkup">
				<ul class="navbar-nav mr-auto "
					style="font-family: 'Cafe24SsurroundAir', 'notosans';">

					<li class="category-item col-lg-auto"><a href="#"
					...
					<li class="category-item col-lg-auto"><a href="#"
						style="color: black;"> <i class="fas fa-dog fa-2x"></i><br>애완운동
					</a></li>
				</ul>
			</div>
		</nav>
				...
				<div class="row">
					...
					<div class="btn-group">
						<button type="button" class="btn btn-primary btn-lg"
							style="font-size: 19px;">일반회원</button>
						<button type="button" class="btn btn-primary btn-lg"
							style="font-size: 19px;">전문회원</button>
