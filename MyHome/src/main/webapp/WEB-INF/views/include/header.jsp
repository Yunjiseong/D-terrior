   ...
   <nav id="total-nav">
         ...
         <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto ">
               <li class="nav-item active " id="id2"><a class="nav-link"
                  href="${pageContext.request.contextPath}/store/storeList">스토어</a></li>
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto ">
                  <li class="nav-item active"><a class="nav-link"
                     href="${pageContext.request.contextPath}/user/userLoginPage">로그인
                  </a></li>
                  <li class="nav-item active popup"><a class="nav-link popup"
                     href="">회원가입</a></li>
                  <li class="nav-item active"><a class="nav-link"
                     href="${pageContext.request.contextPath}/user/qna">고객센터</a></li>
               </ul>
            </div>
            <div class="collapse navbar-collapse " id="navbarSupportedContent"></div>
            <div class="collapse navbar-collapse " id="navbarSupportedContent"></div>
         ...
         <c:if test="${sessionScope.user != null}">
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
               <ul class="navbar-nav mr-auto ">
                  ...
                  <li class="nav-item active"><a class="nav-link"
                     href="${pageContext.request.contextPath}/user/mypage">mypage</a>
                  </li>
                  <li class="nav-item active"><a class="nav-link"
                     href="${pageContext.request.contextPath}/user/qna">고객센터</a></li>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top fixed-top2  "
         ...
         <div class="collapse navbar-collapse container header-categorys ">
            <ul class="list-st mr-auto"style="font-family: 'Cafe24SsurroundAir', 'notosans';"
               id="navbarSupportedContent">
