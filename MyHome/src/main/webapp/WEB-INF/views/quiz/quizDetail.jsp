		...
		<div class="contentForm col-xs-12 col-md-12">
			...
			<div class="btn-group btn-group-sm float-right " role="group"
				...
				<c:if test="${user.nickName == article.writer }">
					<input type="submit" id="modBtn" class="btn btn-info btns"
						value="수정">
					<input type="button" id="delBtn" class="btn btn-info btns"
						value="삭제">
				</c:if>
				<input type="button" id="listBtn" class="btn btn-info btns style="
					margin: 0 0 30px 0;"  value="목록">
			</div>
		</div>
	</form>
	<!-- Reply Form {s} -->
