...
<html>
<head>
<title>Web Socket Chat(관리자용)</title>
<style>
/* 여러 채팅창 간의 간격과 배열 위치*/
.float-left {
	float: left;
...
<body>
	...
	<div class="template" style="display: none">
		...
		<textarea rows="15" cols="50" class="console" disabled="disabled"></textarea>
		<br />
		<form>
			<!-- 메시지 텍스트 박스 -->
	...
	<script type="text/javascript">
		...
		var webSocket = new WebSocket("ws://localhost:8181/myWeb/admin");
