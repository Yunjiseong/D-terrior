	...
	<div class="card align-middle"
		...
		<div class="card-body">
			<form class="form-signin" action="login" method="post">
				...
				<label for="inputEmail" class="sr-only">E-mail</label> <input type="text" id="id" class="form-control" placeholder="E-mail"
					name="id" required autofocus><BR> <label
					for="inputPassword" class="sr-only">Password</label> <input	type="password" id="pw" class="form-control" placeholder="Password"
					name="pw" required><br>
				<div class="checkbox">
					<label> <input id="idSaveCheck" type="checkbox" value="remember-me"> 기억하기
					</label>
				</div>

				<button id="#" class="btn btn-lg btn-primary btn-block"	type="submit">로 그 인</button>
				<button id="'#"
					class="btn btn-lg btn-primary btn-block btn-open-popup " type="submit">회원가입</button>
			</form>
		</div>
	</div>
	<!--모달창-->
