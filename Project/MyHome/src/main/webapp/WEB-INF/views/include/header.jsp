...
<title>D'terrior</title>
 ...
 <body>
  <nav class="navbar navbar-expand-lg navbar-header fixed-top " id="nav-main"
        ...
        <div class="container">
            <a class="navbar-brand" href="/myWeb"><img class="navbar-brand " src="${pageContext.request.contextPath}/resources/img/logo2.jpg"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent"
              ...
              <ul class="navbar-nav">
                <li class="nav-item vi3">
                  <a class="nav-link" href="${pageContext.request.contextPath}/user/userLoginPage" style="color: black;"> 로그인</a>
                </li>

                <li class="nav-item vi4">
                  <a class="nav-link" href="${pageContext.request.contextPath}/user/normalJoinPage" style="color: black;">회원가입</a>
                </li>
                <li class="nav-item vi5">
                  <a class="nav-link " href="${pageContext.request.contextPath}/user/qna" style="color: black;">고객센터</a>
                </li>
